    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section id="lich" className="border-b border-[color:var(--navy)]/10 bg-[color:var(--paper)]"><div className="mx-auto max-w-[1440px] px-5 py-8 lg:px-10 lg:py-10">
        ...
        <div className="grid gap-3 rounded-2xl border border-[color:var(--navy)]/10 bg-white p-3 shadow-[0_12px_40px_rgba(25,46,62,.06)] md:grid-cols-[minmax(240px,1fr)_180px_180px_140px]">
          ...
          <NativeSelect className="w-full"><NativeSelectOption>Mùa phụng vụ</NativeSelectOption><NativeSelectOption>Mùa Vọng</NativeSelectOption><NativeSelectOption>Giáng Sinh</NativeSelectOption></NativeSelect>
          <NativeSelect className="w-full"><NativeSelectOption>Bậc lễ</NativeSelectOption><NativeSelectOption>Chúa Nhật</NativeSelectOption><NativeSelectOption>Lễ Trọng</NativeSelectOption></NativeSelect>
